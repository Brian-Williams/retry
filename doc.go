...
// 	`retry.Concurrent(func() error{ return nil }, retry.StopMaxAttempts(n)`
// To the more verbose:
...
// 	`retry.Concurrent(func() error{ return nil}, retry.IfNoError(), retry.StopMaxAttempts(n)`
...
// 	`retry.Concurrent(func() error{ return nil }, retry.Always(), retry.StopOr(retry.StopIfError(), retry.StopMaxAttempts(5))`
package retry
